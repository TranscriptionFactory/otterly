...
| `phase3_metadata_and_bases.md`                | Metadata index plus Bases foundations — **COMPLETED**                   | Reference for metadata cache consumers (graph, tasks, plugins)       | Shared model for frontmatter, properties, queries, and early view types      |
