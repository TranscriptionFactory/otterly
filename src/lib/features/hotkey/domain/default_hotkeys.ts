...
export const DEFAULT_HOTKEYS: HotkeyBinding[] = [
  ...
  {
    action_id: ACTION_IDS.git_fetch,
    key: "CmdOrCtrl+Alt+Shift+F",
    phase: "capture",
    label: "Git Fetch",
    description: "Refresh remote status without merging",
    category: "general",
  },
  {
    action_id: ACTION_IDS.git_pull,
    key: "CmdOrCtrl+Alt+Shift+U",
    phase: "capture",
    label: "Git Pull",
  ...
  {
    action_id: ACTION_IDS.git_push,
    key: "CmdOrCtrl+Alt+Shift+P",
    phase: "capture",
    label: "Git Push",
  ...
  {
    action_id: ACTION_IDS.git_add_remote,
    key: "CmdOrCtrl+Alt+Shift+R",
    phase: "capture",
    label: "Add Git Remote",
    description: "Configure a remote repository for this vault",
    category: "general",
  },
  {
