export { SplitViewStore } from "$lib/features/split_view/state/split_view_store.svelte";
export { SplitViewService } from "$lib/features/split_view/application/split_view_service";
